                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="float-right">
                                            <input type="radio" id="html" name="payment_method" value="1"
                                                   onchange="show(this.value)" required>
                            ...
                            <div class="row" id="show_cred" style="display:none">
                                <div class="col-md-6 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="parcels" id="parcels" class="form-control"
                                               value="{{ old('parcels') }}" oninput="calc();">
                                ...
                                <div class="col-md-6 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1" step="any" name="parcel_vl" id="parcel_vl"
                                               class="form-control" value="{{ old('parcel_vl') }}">
