...
<nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <li class="nav-item dropdown">
            ...
            <a class="nav-link">
                <div id="clock">
                <b>{{\Carbon\Carbon::now()->setTimezone(\Illuminate\Support\Facades\Auth::user()->timezone->name)->format('H:i:s')}}</b>
                </div>
            </a>
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <a class="dropdown-item"
                   href="{{ route('user_groups.index') }}">{{ __("profile.user_groups.title") }}</a>
