		...
		<div class="card card-outline card-primary">
			<div class="card-header text-center">
				<div class="text-center">
					<img class="profile-user-img img-fluid" style="border:0;" src="{{ asset('assets') }}/dist/img/moneymap_logo.png"
						alt="MoneyMap Logo">
				</div>
			</div>
			<div class="card-body">
				...
				<form role="form" method="POST" action="{{ route('login') }}">
					...
					<div class="row">
						...
						<!-- /.col -->
						<div class="col-4">
							<button type="submit" class="btn btn-primary btn-block">{{ __('general.menu.login') }}</button>
						</div>
						<!-- /.col -->
					</div>
				</form>
				...
				<p class="mb-1">
					<a href="{{ route('password.request') }}" class="link footer-link">{{ __('auth.forgot_password') }}</a>
				</p>
