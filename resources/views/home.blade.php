				...
				<div class="col-12 col-sm-6 col-md-3">
					<div class="info-box mb-3">
						...
						<div class="info-box-content">
							...
							<span class="info-box-number">
								{{ __('general.M_s') . ' ' . number_format($exp_by_budget_this_month->sum('total') + $sum_parcels_this_month->sum('parcel_vl'), 2) }}
								<font size="1">
				...
				<div class="col-12 col-sm-6 col-md-3">
					<div class="info-box mb-3">
						...
						<div class="info-box-content">
							...
							<span class="info-box-number">{{ __('general.M_s') . ' ' . number_format($investments->sum('value'), 2) }}</span>
						</div>
						<!-- /.info-box-content -->
					</div>
					<!-- /.info-box -->
