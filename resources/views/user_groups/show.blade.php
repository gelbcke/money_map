                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a class="btn btn-sm btn-info" href="{{route('user_groups.create')}}">Criar</a>
                            <a class="btn btn-sm btn-success" href="{{route('user_groups.index')}}">Voltar</a>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form id="remove_{{$value->id}}" action="{{route('user_groups.remove_user',['group_id' => $value->group_id, 'user_id' => $value->id])}}" method="POST">@csrf
